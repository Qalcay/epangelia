...
const SUFFIX: [&[&str]; 8] = [
    ...
    &["the Wind", "the Gale", "the Air", "Swiftness", "the Windstorm", "Flow", "Force"],
...
fn prefix_for(dominant: &str, step: u32) -> &'static str {
    ...
    match dominant {
        ...
        "attack_sweep"      => ["Proding", "Wide", "Furlong"][i],
